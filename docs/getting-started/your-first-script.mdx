...
<Quiz
  ...
  options={[
    ...
    { text: "To create separate data for each shape using the script", correct: true },
    { text: "It's optional, just for style" },
    { text: "To connect to the internet" },
  ]}
  explanation="The factory function creates a fresh set of data for each shape. Without it, all shapes would share the same variables!"
/>
