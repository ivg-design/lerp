...
### Exercise 8: Fix Conflicting Winding in a Spike Burst ⭐⭐⭐ {#exercise-8-fix-conflicting-winding-in-a-spike-burst}
...
<ExerciseValidator
    exerciseId="advanced-procedural-8"
    expectedAnswer="ANSWER: winding-fixed"
/>
