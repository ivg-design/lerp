...
keywords:
  ...
  - dynamic
  - instantiation
description: "Create and manage Rive artboard instances with Luau. Practice reusable components, runtime spawning, and collections of interactive objects."
---
...
`runtime-v0.1.384` keeps nested-artboard semantic state on the nested instance,
