...
**Core steps:**
1. Add an `Input<Artboard<Data.YourVM>>` to reference a component <Term>Artboard</Term>
...
Dynamic instantiation creates runtime copies of component artboards. You must call advance() and draw() on each instance every frame.
