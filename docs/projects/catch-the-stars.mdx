...
3. Add this <Term>Node</Term> script to the <Term>Artboard</Term>, then position it in the play area or nest the script node under a group for normal hierarchy behavior
