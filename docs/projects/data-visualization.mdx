...
description: "Build a Rive bar chart driven by ViewModel data in this LERP project, with a Luau script and step-by-step setup."
keywords:
  - rive
  - luau
  - scripting
...
3. Add this <Term>Node</Term> script to the <Term>Artboard</Term>, then position it near the chart or nest the script node under a group for normal hierarchy behavior
...
- Continue to [Catch the Stars](/projects/catch-the-stars)
