...
At the current compatibility baseline (npm runtime line `2.37.6`, source snapshot `runtime-v0.1.64` at `b25a322`, audited May 12, 2026), `viewModel.name` is documented upstream but not exposed in the C++ Luau bindings.
