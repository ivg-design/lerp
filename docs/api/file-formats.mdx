...
editor/LSP FileFormat declarations. They are not C++ runtime-v0.1.384 Context
methods. The exact Web `2.42.1` target consumes exported text documents as Blob
...
At `runtime-v0.1.384`, Blob exposes only `name`, `size`, and `data`;
