...
**See Also:** [Renderer.drawImage](./drawing#rendererdrawimageimage-sampler-blendmode-opacity), [GPU Shaders](./gpu-shaders#image-color-and-buffer-utilities)
...
`runtime-v0.1.384` exposes no Blob string-conversion method. Guard `data` and
...
- Continue to [Path Effects](/api/path-effects)
