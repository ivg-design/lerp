...
sidebar_position: 8
title: Data Values
description: "Rive Luau API reference for typed DataValue containers and ViewModel properties, including numeric, string, boolean, and color values."
keywords:
  - rive
  - luau
  - scripting
