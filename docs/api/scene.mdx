...
> **Note:** These methods take raw coordinates for event forwarding. Node script handlers receive `PointerEvent` objects instead. See [PointerEvent](./events#pointerevent).
