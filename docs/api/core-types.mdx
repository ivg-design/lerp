---
sidebar_position: 1
title: Rive Core Types API Reference
description: "Rive Luau API reference for Vector, Color, Mat2D, and Mat4: positions, colors, transforms, constructors, properties, and operations."
keywords:
  - rive
  - luau
  - scripting
...
accepted `runtime-v0.1.384` target.
