...
Configuration types for <Term>Paint</Term> styles, blend modes, and gradients.
...
BlendMode values are **string literals**, not namespaced constants.
...
- Continue to [Hierarchy](/api/hierarchy)
