...
### Exercise 1: Array Basics ⭐ {#exercise-1-array-basics}
...
### Exercise 2: Dictionary Lookup ⭐ {#exercise-2-dictionary-lookup}
...
### Exercise 3: Insert and Remove ⭐ {#exercise-3-insert-and-remove}
...
### Exercise 4: Copy vs Reference ⭐⭐ {#exercise-4-copy-vs-reference}
...
### Exercise 5: Nested Tables ⭐⭐ {#exercise-5-nested-tables}
...
### Exercise 6: Sorting Tables ⭐⭐ {#exercise-6-sorting-tables}
...
- Continue to [Iteration](/fundamentals/iteration)
