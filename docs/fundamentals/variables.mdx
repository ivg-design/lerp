...
- **Beginners:** [Your First Rive Script](/getting-started/your-first-script) - teaches from scratch
- **Experienced devs:** [How Rive Scripts Work](/getting-started/how-rive-scripts-work) - uses JS/AE comparisons
...
2. **Create required elements:**
   - Draw any simple shape on the artboard as a visual anchor

3. **Add the script to the artboard:**
   - Right-click the artboard, choose `Exercise1_CharacterStats`, and place the script node near the shape
...
3. **Add the script to the artboard and run:**
   - Right-click the artboard, choose `Exercise2_DamageBreakdown`, and place the script node near the shape
