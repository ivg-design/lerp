...
Enabled with `--!strict`, this mode activates Luau's type checker. In Rive, the directive is optional but recommended because strict typing is enforced either way.

```lua
--!strict  -- Recommended first line if included
