...
A script type for custom logic that runs when a state machine listener event fires. Uses `init` and `perform` protocol methods.
...
| **Drawing** | [Path](#path), [Paint](#paint), [Renderer](#renderer), [Color](#color), [Gradient](#gradient), [Mat2D](#mat2d), [Vector](#vector), [ImageSampler](#imagesampler) |
...
| **Script Types** | [Node Protocol](#node-protocol), [Util Protocol](#util-protocol), [ListenerAction](#listeneraction), [TransitionCondition](#transitioncondition), [Factory Function](#factory-function), [Module](#module), [require](#require) |
