...
Rive scripts are not classes. When you need reusable behavior (drawing helpers, physics helpers, layout logic), you build **prototype tables** with metatables. This lets <Term>Node</Term> scripts share methods and data structures without leaving the Rive scripting environment.
...
### Exercise 1: Basic Metatable ⭐ {#exercise-1-basic-metatable}
...
### Exercise 2: Class Pattern ⭐ {#exercise-2-class-pattern}
...
### Exercise 3: Shared Methods ⭐ {#exercise-3-shared-methods}
...
### Exercise 4: Default Styles ⭐⭐ {#exercise-4-default-styles}
...
### Exercise 5: Computed __index ⭐⭐ {#exercise-5-computed-index}
...
### Exercise 6: __tostring Metamethod ⭐⭐ {#exercise-6-tostring-metamethod}
...
- Continue to [The __index Metamethod](/oop/index-metamethod)
