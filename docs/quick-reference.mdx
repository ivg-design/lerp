...
See [Runtime Compatibility Baseline](/rive/runtime-compatibility) for the pinned upstream source snapshot (`runtime-v0.1.64` at `b25a322`), current C++ WASM runtime release line (`2.37.6`), and the June 4, 2026 shader Early Access baseline addendum.
:::
