...
description: "Look up Rive Luau syntax, script protocols, core types, and common patterns. Includes links to the API and runtime compatibility baseline."
keywords:
  - rive
  - luau
  - scripting
...
Web `2.42.1` -> C++ `runtime-v0.1.384`, the separate landing wrapper lane, and
editor/GPU tiers.
:::

:::caution GPU Canvas on Web
Web `2.42.1` requires the experimental host option
...
exact target's C++ Luau Context; use `print(...)` for Web `2.42.1` portability.
