...
description: "Learn the Rive TransitionCondition script protocol for custom state-machine transition logic, with lifecycle methods and examples."
keywords:
  - rive
  - luau
  - scripting
...
<Quiz
  ...
  options={[
    ...
    { text: "performAction(self, listenerContext)" },
