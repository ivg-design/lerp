...
Last revalidated against the released runtime boundary: 2026-09-04 (direct
Web `2.42.0` line -> C++ `runtime-v0.1.344`; the bundled React landing resolves
Canvas `2.42.0`, and Web GPU Canvas is an experimental, default-off host mode
that remains separate from editor packaging and per-host support).
