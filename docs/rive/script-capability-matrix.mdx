...
Matrix details use the accepted direct Web boundary `2.42.1` -> C++
`runtime-v0.1.384`; current editor-only and later-source findings are labelled
separately. GPU callback guidance remains rollout-dependent. Web `2.42.1` adds
