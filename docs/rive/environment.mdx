...
| Type checking | TypeScript (optional) | `--!strict` (optional; strict typing enforced) |
...
Strict mode catches type mismatches at edit time rather than runtime. This is similar to TypeScript vs JavaScript—you get errors in the editor before running your code. Rive enforces strict typing either way; `--!strict` is optional but recommended for clarity.
...
<Quiz
  ...
  options={[
    ...
    { text: "It makes strict typing explicit (Rive enforces it anyway)", correct: true },
    { text: "It allows network access" },
    { text: "It changes runtime performance" },
  ]}
  explanation="--!strict makes strict typing explicit for the Luau toolchain. Rive enforces strict typing regardless, so the directive is optional but recommended."
/>
...
```lua
-- Strict typing is still enforced, but clarity is reduced
export type MyNode = {}
-- Script runs with strict typing enforced

-- RECOMMENDED: Include --!strict for clarity
--!strict
export type MyNode = {}
...
- `--!strict` makes strict typing explicit (Rive enforces strict typing regardless)
