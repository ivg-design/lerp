...
- **Upstream source snapshot (API surface audit):** `runtime-v0.1.64` at commit `b25a32218c6308ac8dc4b1cb69df62de84d78ba4`
- **Current C++ WASM runtime release line (npm):** `2.37.6`
- **Checked npm packages:** `@rive-app/canvas`, `@rive-app/canvas-lite`, `@rive-app/webgl2`, `@rive-app/canvas-advanced` (all resolved to `2.37.6`)
- **Runtime source gitHead (npm metadata for `@rive-app/canvas@2.37.6`):** `2833de372c0d22596494c89c328008ce5b1106d7`
- **npm publish timestamp for `2.37.6`:** May 8, 2026 (UTC)
...
## Newly Validated Runtime Surfaces (May 12, 2026)

These were validated against upstream `runtime-v0.1.64` and are now reflected in LERP course docs.
...
The main baseline above remains the May 12, 2026 course-wide audit. Shader/GPU scripting now has a newer **shader-specific baseline** based on the runtime-v0.1.106 shader reference and corrected local shader examples, but this material is currently **Rive Early Access only**.
...
- **Shader API reference reviewed:** `runtime-v0.1.106` shader reference
