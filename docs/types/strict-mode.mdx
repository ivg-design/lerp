...
- Know why `--!strict` is recommended for Rive scripts
...
<Quiz
  ...
  type="code"
  answer="--!strict"
  explanation="The --!strict directive should be the first line of your script. It enables full type checking which is strongly recommended for catching errors early."
/>
...
- [ ] I understand why `--!strict` is recommended for Rive scripts
