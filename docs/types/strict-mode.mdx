...
<Quiz
  question="What directive enables full type checking in Luau scripts?"
  id="strict-q1"
  options={[
    { text: "--!strict", correct: true },
    { text: "--!nonstrict" },
    { text: "--!nocheck" },
    { text: "No directive needed (strict is always on)" },
  ]}
  explanation="The --!strict directive enables full type checking. In Rive, strict mode is enabled by default, so you don't need to add this directive manually—but you can include it for clarity."
/>
...
<Quiz
  question="Why does Rive use strict mode by default?"
  id="strict-q4"
  options={[
  ...
  explanation="Strict mode catches type errors before your animation runs, provides better autocomplete in the editor, and ensures more reliable runtime behavior. Rive enables this by default for all scripts."
/>
